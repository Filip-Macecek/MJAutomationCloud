...
namespace MJAutomationCloud.Infrastructure.Migrations
{
    ...
    [Migration("20250831180502_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MJAutomationCloud.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MJAutomationCloud.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MJAutomationCloud.Domain.Entities.PasswordResetToken", b =>
                {
                    b.HasOne("MJAutomationCloud.Domain.Entities.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MJAutomationCloud.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
